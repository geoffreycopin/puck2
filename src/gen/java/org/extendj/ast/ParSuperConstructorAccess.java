...
/**
 * @ast node
 * @declaredat /home/hadjer/git/puck2/extendj/java5/grammar/GenericMethods.ast:21
...
public class ParSuperConstructorAccess extends SuperConstructorAccess implements Cloneable {
   ...
   * @declaredat /home/hadjer/git/puck2/extendj/java5/frontend/GenericMethods.jrag:276
   */
  ...
  public NameType Define_nameType(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getTypeArgumentListNoTransform()) {
      // @declaredat /home/hadjer/git/puck2/extendj/java5/frontend/GenericMethods.jrag:226
  ...
  public SimpleSet<TypeDecl> Define_lookupType(ASTNode _callerNode, ASTNode _childNode, String name) {
    if (_callerNode == getTypeArgumentListNoTransform()) {
      // @declaredat /home/hadjer/git/puck2/extendj/java5/frontend/GenericMethods.jrag:227
      int childIndex = _callerNode.getIndexOfChild(_childNode);
