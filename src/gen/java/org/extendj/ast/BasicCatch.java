 ...
 * @ast node
 * @declaredat /home/hadjer/git/puck2/extendj/java7/grammar/MultiCatch.ast:9
...
public class BasicCatch extends CatchClause implements Cloneable {
   ...
   * @declaredat /home/hadjer/git/puck2/extendj/java4/frontend/PrettyPrint.jadd:88
   */
   ...
   * @declaredat /home/hadjer/git/puck2/extendj/java4/frontend/LookupVariable.jrag:192
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="VariableScope", declaredAt="/home/hadjer/git/puck2/extendj/java4/frontend/LookupVariable.jrag:192")
   ...
   * @declaredat /home/hadjer/git/puck2/extendj/java4/frontend/ExceptionHandling.jrag:279
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="ExceptionHandling", declaredAt="/home/hadjer/git/puck2/extendj/java4/frontend/ExceptionHandling.jrag:279")
  ...
  public SimpleSet<Variable> Define_lookupVariable(ASTNode _callerNode, ASTNode _childNode, String name) {
    if (getParameterNoTransform() != null && _callerNode == getParameter()) {
      // @declaredat /home/hadjer/git/puck2/extendj/java4/frontend/LookupVariable.jrag:145
  ...
  public boolean Define_reachable(ASTNode _callerNode, ASTNode _childNode) {
    if (getBlockNoTransform() != null && _callerNode == getBlock()) {
      // @declaredat /home/hadjer/git/puck2/extendj/java4/frontend/UnreachableStatements.jrag:177
  ...
  public boolean Define_isMethodParameter(ASTNode _callerNode, ASTNode _childNode) {
    if (getParameterNoTransform() != null && _callerNode == getParameter()) {
      // @declaredat /home/hadjer/git/puck2/extendj/java4/frontend/VariableDeclaration.jrag:95
      return false;
    }
    else {
  ...
  public boolean Define_isConstructorParameter(ASTNode _callerNode, ASTNode _childNode) {
    if (getParameterNoTransform() != null && _callerNode == getParameter()) {
      // @declaredat /home/hadjer/git/puck2/extendj/java4/frontend/VariableDeclaration.jrag:96
      return false;
    }
    else {
  ...
  public boolean Define_isExceptionHandlerParameter(ASTNode _callerNode, ASTNode _childNode) {
    if (getParameterNoTransform() != null && _callerNode == getParameter()) {
      // @declaredat /home/hadjer/git/puck2/extendj/java4/frontend/VariableDeclaration.jrag:97
      return true;
    }
    else {
  ...
  public VariableScope Define_outerScope(ASTNode _callerNode, ASTNode _childNode) {
    if (getParameterNoTransform() != null && _callerNode == getParameter()) {
      // @declaredat /home/hadjer/git/puck2/extendj/java4/frontend/NameCheck.jrag:443
      return this;
    }
    else {
  ...
  public NameType Define_nameType(ASTNode _callerNode, ASTNode _childNode) {
    if (getParameterNoTransform() != null && _callerNode == getParameter()) {
      // @declaredat /home/hadjer/git/puck2/extendj/java4/frontend/SyntacticClassification.jrag:109
  ...
  public boolean Define_variableArityValid(ASTNode _callerNode, ASTNode _childNode) {
    if (getParameterNoTransform() != null && _callerNode == getParameter()) {
      // @declaredat /home/hadjer/git/puck2/extendj/java5/frontend/VariableArityParameters.jrag:43
      return false;
    }
    else {
  ...
  public boolean Define_inhModifiedInScope(ASTNode _callerNode, ASTNode _childNode, Variable var) {
    if (getParameterNoTransform() != null && _callerNode == getParameter()) {
      // @declaredat /home/hadjer/git/puck2/extendj/java7/frontend/PreciseRethrow.jrag:75
  ...
  protected void collect_contributors_CompilationUnit_problems(CompilationUnit _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /home/hadjer/git/puck2/extendj/java4/frontend/TypeCheck.jrag:491
    ...
    // @declaredat /home/hadjer/git/puck2/extendj/java7/frontend/PreciseRethrow.jrag:283
