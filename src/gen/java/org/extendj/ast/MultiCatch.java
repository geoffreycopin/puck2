 ...
 * @ast node
 * @declaredat /home/hadjer/git/puck2/extendj/java7/grammar/MultiCatch.ast:14
...
public class MultiCatch extends CatchClause implements Cloneable {
   ...
   * @declaredat /home/hadjer/git/puck2/extendj/java7/frontend/PrettyPrint.jadd:50
   */
   ...
   * @attribute syn
   * @aspect MultiCatch
   * @declaredat /home/hadjer/git/puck2/extendj/java7/frontend/MultiCatch.jrag:197
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="MultiCatch", declaredAt="/home/hadjer/git/puck2/extendj/java7/frontend/MultiCatch.jrag:197")
  ...
  public SimpleSet<Variable> Define_lookupVariable(ASTNode _callerNode, ASTNode _childNode, String name) {
    if (getParameterNoTransform() != null && _callerNode == getParameter()) {
      // @declaredat /home/hadjer/git/puck2/extendj/java7/frontend/MultiCatch.jrag:127
  ...
  public boolean Define_reachable(ASTNode _callerNode, ASTNode _childNode) {
    if (getBlockNoTransform() != null && _callerNode == getBlock()) {
      // @declaredat /home/hadjer/git/puck2/extendj/java7/frontend/MultiCatch.jrag:180
      {
  ...
  protected void collect_contributors_CompilationUnit_problems(CompilationUnit _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /home/hadjer/git/puck2/extendj/java7/frontend/PreciseRethrow.jrag:289
    ...
    // @declaredat /home/hadjer/git/puck2/extendj/java7/frontend/MultiCatch.jrag:195
    {
      java.util.Set<ASTNode> contributors = _map.get(_root);
      if (contributors == null) {
        contributors = new java.util.LinkedHashSet<ASTNode>();
