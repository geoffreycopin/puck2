...
/**
 * @ast node
 * @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/grammar/EnhancedFor.ast:1
...
public class EnhancedForStmt extends BranchTargetStmt implements Cloneable, VariableScope {
  /**
   * @aspect EnhancedFor
   * @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:158
   */
   ...
   * @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/GenericMethodsInference.jrag:81
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN, isNTA=true)
  @ASTNodeAnnotation.Source(aspect="GenericMethodsInference", declaredAt="/Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/GenericMethodsInference.jrag:81")
   ...
   * @attribute syn
   * @aspect EnhancedFor
   * @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:45
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="EnhancedFor", declaredAt="/Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:45")
   ...
   * @attribute syn
   * @aspect EnhancedFor
   * @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:150
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="EnhancedFor", declaredAt="/Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:150")
   ...
   * @attribute inh
   * @aspect EnhancedFor
   * @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:138
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="EnhancedFor", declaredAt="/Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:138")
  ...
  public FieldDeclarator Define_erasedField(ASTNode _callerNode, ASTNode _childNode) {
    if (getVariableDeclNoTransform() != null && _callerNode == getVariableDecl()) {
      // @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/Generics.jrag:1654
      {
  ...
  public SimpleSet<Variable> Define_lookupVariable(ASTNode _callerNode, ASTNode _childNode, String name) {
    if (getStmtNoTransform() != null && _callerNode == getStmt()) {
      // @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:141
      return localLookupVariable(name);
    }
    else if (getExprNoTransform() != null && _callerNode == getExpr()) {
      // @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:140
      return localLookupVariable(name);
    }
    else if (getVariableDeclNoTransform() != null && _callerNode == getVariableDecl()) {
      // @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:139
      return localLookupVariable(name);
    }
    else {
  ...
  public NameType Define_nameType(ASTNode _callerNode, ASTNode _childNode) {
    if (getTypeAccessNoTransform() != null && _callerNode == getTypeAccess()) {
      // @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:143
  ...
  public VariableScope Define_outerScope(ASTNode _callerNode, ASTNode _childNode) {
    if (getStmtNoTransform() != null && _callerNode == getStmt()) {
      // @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:148
      return this;
    }
    else if (getExprNoTransform() != null && _callerNode == getExpr()) {
      // @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:147
      return this;
    }
    else if (getVariableDeclNoTransform() != null && _callerNode == getVariableDecl()) {
      // @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:146
      return this;
    }
    else {
  ...
  public boolean Define_mayBeFinal(ASTNode _callerNode, ASTNode _childNode) {
    if (getModifiersNoTransform() != null && _callerNode == getModifiers()) {
      // @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:178
      return true;
    }
    else {
  ...
  public boolean Define_isMethodParameter(ASTNode _callerNode, ASTNode _childNode) {
    if (getVariableDeclNoTransform() != null && _callerNode == getVariableDecl()) {
      // @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:182
      return false;
    }
    else {
  ...
  public boolean Define_isConstructorParameter(ASTNode _callerNode, ASTNode _childNode) {
    if (getVariableDeclNoTransform() != null && _callerNode == getVariableDecl()) {
      // @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:183
      return false;
    }
    else {
  ...
  public boolean Define_isExceptionHandlerParameter(ASTNode _callerNode, ASTNode _childNode) {
    if (getVariableDeclNoTransform() != null && _callerNode == getVariableDecl()) {
      // @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:184
      return false;
    }
    else {
  ...
  public Modifiers Define_declarationModifiers(ASTNode _callerNode, ASTNode _childNode) {
    if (getVariableDeclNoTransform() != null && _callerNode == getVariableDecl()) {
      // @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:186
      return getModifiers();
    }
    else {
  ...
  public Access Define_declarationType(ASTNode _callerNode, ASTNode _childNode) {
    if (getVariableDeclNoTransform() != null && _callerNode == getVariableDecl()) {
      // @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:188
  ...
  public boolean Define_reachable(ASTNode _callerNode, ASTNode _childNode) {
    if (getStmtNoTransform() != null && _callerNode == getStmt()) {
      // @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:192
      return reachable();
    }
    else {
  ...
  public boolean Define_assignedBefore(ASTNode _callerNode, ASTNode _childNode, Variable v) {
    if (getStmtNoTransform() != null && _callerNode == getStmt()) {
      // @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:205
      return getExpr().assignedAfter(v);
    }
    else if (getExprNoTransform() != null && _callerNode == getExpr()) {
      // @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:202
  ...
  public boolean Define_unassignedBefore(ASTNode _callerNode, ASTNode _childNode, Variable v) {
    if (getStmtNoTransform() != null && _callerNode == getStmt()) {
      ...
      // @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:219
  ...
  public TypeDecl Define_targetType(ASTNode _callerNode, ASTNode _childNode) {
    if (getExprNoTransform() != null && _callerNode == getExpr()) {
      // @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java8/frontend/TargetType.jrag:43
      return iterableTypeAccess().type();
    }
    else {
  ...
  public boolean Define_inhModifiedInScope(ASTNode _callerNode, ASTNode _childNode, Variable var) {
    if (getStmtNoTransform() != null && _callerNode == getStmt()) {
      // @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java8/frontend/EffectivelyFinal.jrag:49
      return false;
    }
    else if (getVariableDeclNoTransform() != null && _callerNode == getVariableDecl()) {
      // @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java8/frontend/EffectivelyFinal.jrag:48
  ...
  protected void collect_contributors_CompilationUnit_problems(CompilationUnit _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /Users/geoffrey/IdeaProjects/puck2/extendj/java5/frontend/EnhancedFor.jrag:43
    {
