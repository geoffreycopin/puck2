...
/**
 * @ast node
 * @declaredat /home/hadjer/git/puck2/extendj/java5/grammar/GenericMethods.ast:20
...
public class ParConstructorAccess extends ConstructorAccess implements Cloneable {
   ...
   * @declaredat /home/hadjer/git/puck2/extendj/java5/frontend/GenericMethods.jrag:264
   */
  ...
  public NameType Define_nameType(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getTypeArgumentListNoTransform()) {
      // @declaredat /home/hadjer/git/puck2/extendj/java5/frontend/GenericMethods.jrag:223
  ...
  public SimpleSet<TypeDecl> Define_lookupType(ASTNode _callerNode, ASTNode _childNode, String name) {
    if (_callerNode == getTypeArgumentListNoTransform()) {
      // @declaredat /home/hadjer/git/puck2/extendj/java5/frontend/GenericMethods.jrag:224
      int childIndex = _callerNode.getIndexOfChild(_childNode);
